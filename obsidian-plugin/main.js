...
`;let P=()=>{let d=hr(i());d.ok&&(f.value=d.text??""),l.setText(d.message),o()};new _.Setting(p).setName("\u4ECE\u6587\u4EF6\u8F7D\u5165").setDesc("\u628A\u78C1\u76D8\u4E0A\u7684 mcp_servers.json \u91CD\u65B0\u8F7D\u5165\u5230\u7F16\u8F91\u5668\u3002").addButton(d=>{d.setButtonText("\u8F7D\u5165"),d.onClick(()=>{P()})}),new _.Setting(p).setName("\u4ECE\u6A21\u677F\u521B\u5EFA").setDesc("\u5F53\u771F\u5B9E\u914D\u7F6E\u6587\u4EF6\u4E0D\u5B58\u5728\u65F6\uFF0C\u6839\u636E mcp_servers.example.json \u521B\u5EFA\u3002").addButton(d=>{d.setButtonText("\u521B\u5EFA"),d.onClick(async()=>{await c();let S=fr(this.plugin.settings);S.ok?(f.value=S.text??"",l.setText(S.message),new _.Notice("\u5DF2\u6839\u636E\u6A21\u677F\u521B\u5EFA MCP \u914D\u7F6E\u6587\u4EF6\u3002")):(l.setText(S.message),new _.Notice(`\u521B\u5EFA\u5931\u8D25\uFF1A${S.message}`)),o()})}),new _.Setting(p).setName("\u672C\u5730\u6821\u9A8C").setDesc("\u53EA\u6821\u9A8C JSON \u8BED\u6CD5\u548C MCP \u914D\u7F6E\u7ED3\u6784\uFF0C\u4E0D\u4F1A\u5199\u5165\u540E\u7AEF\u3002").addButton(d=>{d.setButtonText("\u6821\u9A8C"),d.onClick(()=>{let S=rn(f.value);l.setText(S.message),S.ok?new _.Notice("MCP \u914D\u7F6E\u6821\u9A8C\u901A\u8FC7\u3002"):new _.Notice(`\u6821\u9A8C\u5931\u8D25\uFF1A${S.message}`)})}),new _.Setting(p).setName("\u4FDD\u5B58\u914D\u7F6E").setDesc("\u628A\u7F16\u8F91\u5668\u5185\u5BB9\u5199\u5165 mcp_servers.json\uFF08\u9700\u8981\u5148\u5728\u9AD8\u7EA7\u8DEF\u5F84\u8986\u76D6\u91CC\u914D\u7F6E\u8DEF\u5F84\uFF0C\u6216\u914D\u7F6E\u597D .env\uFF09\u3002").addButton(d=>{d.setButtonText("\u4FDD\u5B58"),d.onClick(async()=>{await c();let S=sn(this.plugin.settings,f.value);l.setText(S.message),S.ok?new _.Notice("MCP \u914D\u7F6E\u5DF2\u4FDD\u5B58\u3002"):new _.Notice(`\u4FDD\u5B58\u5931\u8D25\uFF1A${S.message}`),o()})}).addButton(d=>{d.setButtonText("\u4FDD\u5B58\u5E76\u91CD\u8F7D"),d.setCta(),d.onClick(async()=>{await c();let S=sn(this.plugin.settings,f.value);if(!S.ok){l.setText(S.message),new _.Notice(`\u4FDD\u5B58\u5931\u8D25\uFF1A${S.message}`),o();return}l.setText(`${S.message} \u6B63\u5728\u91CD\u8F7D\u540E\u7AEF...`);let M=new Y(s()),k=await vr(this.plugin.settings,M);l.setText(k.message),k.ok?(new _.Notice("MCP \u914D\u7F6E\u5DF2\u4FDD\u5B58\uFF0C\u5E76\u5B8C\u6210\u540E\u7AEF\u91CD\u8F7D\u3002"),this.refreshToolRuntimeStatus?.()):new _.Notice(`\u91CD\u8F7D\u5931\u8D25\uFF1A${k.message}`),o()})}),o(),P()}renderLlmSection(n){n.createEl("h3",{text:"LLM \u914D\u7F6E"});let r=Pe(this.plugin.settings),s=n.createDiv({cls:"llm-config-hint"});s.style.fontSize="12px",s.style.marginBottom="10px",s.style.wordBreak="break-word",r.ok&&r.envPath?(s.style.color="var(--text-muted)",s.setText(`\u5F53\u524D\u751F\u6548\u914D\u7F6E\u6587\u4EF6\uFF1A${r.envPath}`)):(s.style.color="var(--text-accent)",s.style.fontWeight="600",s.setText(r.message));let i=n.createDiv({cls:"llm-status-bar"});i.style.fontSize="12px",i.style.color="var(--text-muted)",i.style.marginBottom="10px",i.style.minHeight="18px",i.style.wordBreak="break-word";let a=n.createDiv({cls:"llm-profile-list"});a.style.marginBottom="4px";let l=()=>this.plugin.settings.backendUrl||Re.backendUrl,o=async()=>{i.setText("\u6B63\u5728\u4ECE\u540E\u7AEF\u8BFB\u53D6 LLM \u914D\u7F6E...");try{let d=await this.plugin.syncLlmProfilesFromBackend({migrateLocalProfiles:!1});i.setText(d.message),d.ok&&(P(),c())}catch(d){let S=d instanceof Error?d.message:String(d);i.setText(`\u8BFB\u53D6\u540E\u7AEF LLM \u914D\u7F6E\u5931\u8D25\uFF1A${S}`)}},c=()=>{let d=this.plugin.settings.llmProfiles.find(M=>M.id===this.plugin.settings.activeProfileId&&!Se(M)),S=this.plugin.settings.llmProfiles.find(M=>M.id===this.plugin.settings.activeProfileId&&Se(M));d?i.setText(`\u5F53\u524D\u542F\u7528\uFF1A${d.name}\uFF08${d.provider} / ${d.model}\uFF09`):S?i.setText("\u5F53\u524D\u6B63\u5728\u7F16\u8F91\u672A\u4FDD\u5B58\u8349\u7A3F\u3002\u4FDD\u5B58\u540E\u624D\u80FD\u542F\u7528\u3002"):this.plugin.settings.llmProfiles.length>0?i.setText("\u5F53\u524D\u8FD8\u6CA1\u6709\u9009\u4E2D\u7684\u914D\u7F6E\u3002"):i.setText("\u5F53\u524D\u8FD8\u6CA1\u6709\u521B\u5EFA\u4EFB\u4F55 LLM \u914D\u7F6E\u3002")},u=async d=>{i.setText(`\u6B63\u5728\u5E94\u7528 ${d.name} ...`);let S=new Y(l());try{let M=await ze(this.plugin.settings,d,S,!0);return i.setText(M.message),M.ok?(await this.plugin.saveSettings(),P(),new _.Notice(`\u5DF2\u5207\u6362\u5230 ${d.name}\u3002`),!0):(P(),new _.Notice(`\u5207\u6362\u5931\u8D25\uFF1A${M.message}`),!1)}catch(M){let k=M instanceof Error?M.message:String(M);return i.setText(`\u5207\u6362\u5931\u8D25\uFF1A${k}`),P(),new _.Notice(`\u5207\u6362\u5931\u8D25\uFF1A${k}`),!1}},p=async d=>{let S=d.id===this.plugin.settings.activeProfileId;i.setText(`\u6B63\u5728\u4FDD\u5B58 ${d.name} \u5230\u540E\u7AEF...`);let M=new Y(l());try{let k=await ze(this.plugin.settings,d,M,S);i.setText(k.message),k.ok?(await this.plugin.saveSettings(),P(),c(),new _.Notice(`\u5DF2\u4FDD\u5B58 ${d.name}\u3002`)):new _.Notice(`\u4FDD\u5B58\u5931\u8D25\uFF1A${k.message}`)}catch(k){let L=k instanceof Error?k.message:String(k);i.setText(`\u4FDD\u5B58\u5931\u8D25\uFF1A${L}`),new _.Notice(`\u4FDD\u5B58\u5931\u8D25\uFF1A${L}`)}},f=async()=>{let d=this.plugin.settings.llmProfiles.find(F=>F.id===this.plugin.settings.activeProfileId&&!Se(F)),S=Pe(this.plugin.settings);if(!S.ok||!S.envPath){i.setText(S.message);return}let M=ce(S.envPath,"CRABBY_ADMIN_TOKEN")?.trim();if(!M){i.setText(`\u65E0\u6CD5\u6D4B\u8BD5\u5F53\u524D Profile\uFF1A${S.envPath} \u7F3A\u5C11 CRABBY_ADMIN_TOKEN\u3002`);return}let k=d?`${d.name}\uFF08${d.provider} / ${d.model}\uFF09`:"\u540E\u7AEF\u5F53\u524D\u5DF2\u751F\u6548\u914D\u7F6E";i.setText(`\u6B63\u5728\u6D4B\u8BD5\u5F53\u524D Profile\uFF1A${k}...`);let T=await new Y(l()).testCurrentProfile(M);if(!T.ok||!T.data){let F=T.status===null?"\u540E\u7AEF\u5F53\u524D\u4E0D\u53EF\u8BBF\u95EE\u3002":T.detail||`HTTP ${T.status}`;i.setText(`\u6D4B\u8BD5\u5931\u8D25\uFF1A${F}`),new _.Notice(`\u6D4B\u8BD5\u5931\u8D25\uFF1A${F}`);return}i.setText(T.data.message),new _.Notice(T.data.ok?T.data.message:`\u6D4B\u8BD5\u672A\u901A\u8FC7\uFF1A${T.data.message}`)},P=()=>{if(a.empty(),this.plugin.settings.llmProfiles.length===0){let d=a.createDiv();d.setText("\u8FD8\u6CA1\u6709\u914D\u7F6E\u3002\u70B9\u51FB\u201C\u6DFB\u52A0\u914D\u7F6E\u201D\u521B\u5EFA\u4E00\u4E2A\u65B0\u7684 LLM \u914D\u7F6E\u3002"),d.style.color="var(--text-muted)",d.style.fontStyle="italic",d.style.padding="8px 0";return}this.plugin.settings.llmProfiles.forEach((d,S)=>{ln(d);let M=Se(d),k=d.id===this.plugin.settings.activeProfileId&&!M,L=a.createDiv({cls:"llm-profile-card"});Object.assign(L.style,{border:`1px solid ${k?"var(--interactive-accent)":"var(--background-modifier-border)"}`,borderRadius:"8px",padding:"12px 16px",marginBottom:"10px",backgroundColor:k?"var(--background-secondary-alt)":"var(--background-secondary)",transition:"border-color 0.15s, background-color 0.15s"});let T=L.createDiv();Object.assign(T.style,{display:"flex",alignItems:"center",gap:"8px",marginBottom:"10px",flexWrap:"wrap"});let F=T.createSpan();F.style.fontSize="16px",F.style.cursor="pointer",F.title=k?"\u8FD9\u4E2A\u914D\u7F6E\u5F53\u524D\u5DF2\u542F\u7528\u3002":M?"\u70B9\u51FB\u4FDD\u5B58\u5E76\u542F\u7528\u8FD9\u4E2A\u8349\u7A3F\u914D\u7F6E\u3002":"\u70B9\u51FB\u542F\u7528\u8FD9\u4E2A\u914D\u7F6E\uFF0C\u5E76\u70ED\u91CD\u8F7D\u540E\u7AEF\u3002",F.setText(k?"\u25CF":"\u25CB"),F.addEventListener("click",async()=>{await u(d)});let K=T.createEl("strong"),A=()=>d.name||`\u914D\u7F6E ${S+1}`;K.setText(A()),K.style.flex="1",K.style.minWidth="0",K.style.fontSize="14px",K.style.overflow="hidden",K.style.textOverflow="ellipsis",K.style.whiteSpace="nowrap";let G=Object.fromEntries(bt.map(m=>[m,be(m).badge])),q=T.createSpan();if(Object.assign(q.style,{fontSize:"11px",padding:"2px 8px",borderRadius:"12px",backgroundColor:G[d.provider],color:"#fff",fontWeight:"600",letterSpacing:"0.03em"}),(()=>{let m=String(d.provider||"");q.setText(m.toUpperCase()||"UNKNOWN"),q.style.backgroundColor=G[m]??"var(--text-muted)"})(),M){let m=T.createSpan();Object.assign(m.style,{fontSize:"11px",padding:"2px 8px",borderRadius:"12px",backgroundColor:"var(--background-modifier-border)",color:"var(--text-muted)",fontWeight:"600"}),m.setText("\u8349\u7A3F")}let se=T.createEl("button");se.setText("\u4FDD\u5B58"),se.title=M?"\u628A\u8FD9\u4E2A\u8349\u7A3F\u914D\u7F6E\u4FDD\u5B58\u5230\u540E\u7AEF .env\u3002":k?"\u4FDD\u5B58\u8FD9\u4E2A\u914D\u7F6E\uFF0C\u5E76\u7ACB\u5373\u5E94\u7528\u5230\u540E\u7AEF\u3002":"\u628A\u8FD9\u4E2A\u914D\u7F6E\u4FDD\u5B58\u5230\u540E\u7AEF\u3002",se.addEventListener("click",()=>{p(d)});let v=T.createEl("button");v.setText("\u5220\u9664"),v.title="\u5220\u9664\u8FD9\u4E2A\u914D\u7F6E\u3002",v.addEventListener("click",async()=>{let m=async()=>{this.plugin.settings.llmProfiles=this.plugin.settings.llmProfiles.filter(x=>x.id!==d.id),this.plugin.settings.activeProfileId===d.id&&(this.plugin.settings.activeProfileId=this.plugin.settings.llmProfiles[0]?.id??""),await this.plugin.saveSettings(),P(),c()};i.setText(`\u6B63\u5728\u5220\u9664 ${d.name}...`);let g=new Y(l()),h=await Et(this.plugin.settings,d.id,g);if(i.setText(h.message),!h.ok){if(h.message.includes("Profile not found")){await m(),new _.Notice(`\u5DF2\u5220\u9664\u672C\u5730\u8349\u7A3F ${d.name}\u3002`);return}new _.Notice(`\u5220\u9664\u5931\u8D25\uFF1A${h.message}`);return}await m(),new _.Notice(`\u5DF2\u5220\u9664 ${d.name}\u3002`)});{let{activePreset:m,capabilities:g}=xi(d),h=U=>{Object.assign(U.style,{display:"grid",gridTemplateColumns:"80px minmax(0, 1fr)",alignItems:"center",gap:"8px",marginBottom:"6px"})},x=U=>{Object.assign(U.style,{fontSize:"12px",color:"var(--text-muted)",textAlign:"right"})},w=U=>{Object.assign(U.style,{width:"100%",boxSizing:"border-box",fontSize:"13px",padding:"4px 8px",borderRadius:"4px",border:"1px solid var(--background-modifier-border)",backgroundColor:"var(--background-primary)",color:"var(--text-normal)"})},y=(U,V,B,ne,ue,W="text")=>{let O=U.createDiv();h(O);let H=O.createEl("label");H.setText(V),x(H);let ae=O.createEl("input");return ae.type=W,ae.placeholder=ne,ae.value=B,w(ae),ae.addEventListener("input",async()=>{await ue(ae.value),c()}),ae},C=(U,V,B,ne)=>{let ue=U.createDiv();h(ue);let W=ue.createEl("label");W.setText(V),x(W);let H=ue.createDiv().createEl("input");H.type="checkbox",H.checked=B,H.addEventListener("change",async()=>{await ne(H.checked),c()})};y(L,"Name",d.name,"Daily driver",async U=>{d.name=U,await this.plugin.saveSettings(),K.setText(A())});let D=L.createDiv();h(D);let I=D.createEl("label");I.setText("Provider"),x(I);let Q=D.createEl("select");w(Q),bt.forEach(U=>{let V=Q.createEl("option");V.value=U,V.setText(be(U).label)}),Q.value=d.provider,Q.addEventListener("change",async()=>{d.provider=Q.value;let U=be(d.provider),V=ir(d.provider);d.model=V||d.model,d.baseUrl=U.defaultBaseUrl,ln(d),U.capabilities.thinking||(d.thinkingMode=""),U.capabilities.thinkingBudget||(d.thinkingBudgetTokens="1024"),U.capabilities.reasoningEffort||(d.thinkingEffort=""),U.capabilities.reasoningSplit||(d.reasoningSplit=!1),await this.plugin.saveSettings(),P(),c()});let ie=L.createEl("datalist");ie.id=`llm-models-${d.id}`,m.models.forEach(U=>{let V=ie.createEl("option");V.value=U.id,V.label=U.label});let ee=y(L,"Model",d.model,"Select or type a model id",async U=>{d.model=U.trim(),ln(d),await this.plugin.saveSettings()});if(ee.setAttribute("list",ie.id),ee.addEventListener("change",()=>{P(),c()}),g.baseUrl&&y(L,"Base URL",d.baseUrl,m.defaultBaseUrl,async U=>{d.baseUrl=U.trim(),await this.plugin.saveSettings()}),g.apiKey&&y(L,"API Key",d.apiKey,m.apiKeyEnv||"LLM_API_KEY",async U=>{d.apiKey=U.trim(),await this.plugin.saveSettings()},"password"),g.vision||g.thinking||g.thinkingBudget||g.reasoningEffort||g.reasoningSplit){let U=L.createEl("details");U.style.marginTop="8px";let V=U.createEl("summary");V.setText("Advanced"),V.style.cursor="pointer",V.style.fontSize="12px",V.style.color="var(--text-muted)";let B=U.createDiv();B.style.marginTop="8px",g.vision&&C(B,"Vision",!!d.supportsVision,async ne=>{d.supportsVision=ne,await this.plugin.saveSettings()}),g.thinking&&C(B,"Thinking",d.thinkingMode.trim().toLowerCase()==="enabled",async ne=>{d.thinkingMode=ne?"enabled":"",await this.plugin.saveSettings()}),g.thinkingBudget&&y(B,"Budget",d.thinkingBudgetTokens,"1024",async ne=>{d.thinkingBudgetTokens=ne.trim(),await this.plugin.saveSettings()}),g.reasoningEffort&&y(B,"Effort",d.thinkingEffort,sr(d.provider),async ne=>{d.thinkingEffort=ne.trim(),await this.plugin.saveSettings()}),g.reasoningSplit&&C(B,"Split",!!d.reasoningSplit,async ne=>{d.reasoningSplit=ne,await this.plugin.saveSettings()})}}})};P(),c(),o(),new _.Setting(n).setName("\u5237\u65B0\u540E\u7AEF Profile").setDesc("\u91CD\u65B0\u4ECE\u540E\u7AEF\u8BFB\u53D6\u5F53\u524D LLM Profile \u5217\u8868\u3002").addButton(d=>{d.setButtonText("\u5237\u65B0"),d.onClick(()=>{o()})}),new _.Setting(n).setName("\u6D4B\u8BD5\u5F53\u524D Profile").setDesc("\u6821\u9A8C\u540E\u7AEF\u5F53\u524D\u5DF2\u751F\u6548\u7684 provider\u3001model\u3001key\uFF0C\u5E76\u5728 DeepSeek / MiniMax \u4E0A\u505A\u4E00\u6B21\u4F4E token \u771F\u5B9E\u63A2\u6D4B\u3002").addButton(d=>{d.setButtonText("\u6D4B\u8BD5"),d.onClick(()=>{f()})}),new _.Setting(n).setName("\u6DFB\u52A0\u914D\u7F6E").setDesc("\u65B0\u589E\u4E00\u4E2A LLM \u914D\u7F6E\u9884\u8BBE\u3002").addButton(d=>{d.setButtonText(r.ok?"\u6DFB\u52A0":"\u8BF7\u5148\u521D\u59CB\u5316\u540E\u7AEF"),d.setDisabled(!r.ok),d.onClick(async()=>{let S=this.plugin.settings.llmProfiles.length===0,M={id:Pi(),name:"\u65B0\u914D\u7F6E",provider:"anthropic",model:"claude-sonnet-4-20250514",baseUrl:"",apiKey:"",supportsVision:!1,thinkingMode:"",thinkingEffort:"",thinkingBudgetTokens:"1024",reasoningSplit:!1,isDraft:!0};this.plugin.settings.llmProfiles.push(M),S&&(this.plugin.settings.activeProfileId=M.id),await this.plugin.saveSettings(),P(),c(),i.setText("\u5DF2\u6DFB\u52A0\u65B0\u914D\u7F6E\u8349\u7A3F\u3002\u586B\u5199\u5B8C\u6210\u540E\u70B9\u51FB\u201C\u4FDD\u5B58\u201D\u5199\u5165\u540E\u7AEF .env\u3002")})})}};var ke=require("obsidian"),vn=/\[Image\s+#(\d+)\]/g,Ri=/(^|[^0-9A-Za-z_./\\:-])\/([^\s/]*)$/,Ai=/(^|[^0-9A-Za-z_./\\:-])@"([^"]*)$/,Ii=/(^|[^0-9A-Za-z_./\\:-])@([^\s"]*)$/,Bi=/(^|[^0-9A-Za-z_./\\:-])@"([^"]+)"(#L\d+(?:-\d+)?)?/g,$i=/(^|[^0-9A-Za-z_./\\:-])@([^\s"]+)/g,Er=4,Oi=10*1024*1024;function Cr(t){let{app:e,client:n,elements:r,state:s}=t,i=[],a=1,l={},o=[],c=0,u=null,p=null,f="",P=!1,d=!1,S=0,M=null,k=[];n.listSkills().then(b=>{i=b,ee()}).catch(()=>{i=[]}),n.getCapabilities().then(b=>{M=b}).catch(()=>{M=null});let L=()=>{P?P=!1:ot(),Ye(),Q(),ee()},T=()=>{if(d){d=!1;return}ee()},F=b=>{if(o.length>0){if(b.key==="ArrowDown"){d=!0,b.preventDefault(),b.stopPropagation(),c=(c+1)%o.length,te();return}if(b.key==="ArrowUp"){d=!0,b.preventDefault(),b.stopPropagation(),c=(c-1+o.length)%o.length,te();return}if(b.key==="Tab"||b.key==="Enter"){b.preventDefault(),b.stopPropagation(),U(o[c]);return}if(b.key==="Escape"){d=!0,b.preventDefault(),b.stopPropagation(),o=[],c=0,u=null,te();return}}},K=b=>{let E=Ki(b);E.length!==0&&(b.preventDefault(),y(E))},A=b=>{qi(b.dataTransfer?.files)&&(b.preventDefault(),r.inputAreaEl.classList.add("drag-over"))},G=()=>{r.inputAreaEl.classList.remove("drag-over")},q=b=>{r.inputAreaEl.classList.remove("drag-over");let E=bn(b.dataTransfer?.files);E.length!==0&&(b.preventDefault(),y(E))},re=()=>{r.hiddenFileInput.click()},se=()=>{let b=bn(r.hiddenFileInput.files);r.hiddenFileInput.value="",b.length!==0&&y(b)},v=()=>{w()};r.inputEl.addEventListener("input",L),r.inputEl.addEventListener("keydown",F),r.inputEl.addEventListener("click",T),r.inputEl.addEventListener("keyup",T),r.inputEl.addEventListener("paste",K),r.inputAreaEl.addEventListener("dragover",A),r.inputAreaEl.addEventListener("dragleave",G),r.inputAreaEl.addEventListener("drop",q),r.attachmentBtn.addEventListener("click",re),r.hiddenFileInput.addEventListener("change",se),window.addEventListener("focus",v),k.push(()=>{r.inputEl.removeEventListener("input",L),r.inputEl.removeEventListener("keydown",F),r.inputEl.removeEventListener("click",T),r.inputEl.removeEventListener("keyup",T),r.inputEl.removeEventListener("paste",K),r.inputAreaEl.removeEventListener("dragover",A),r.inputAreaEl.removeEventListener("dragleave",G),r.inputAreaEl.removeEventListener("drop",q),r.attachmentBtn.removeEventListener("click",re),r.hiddenFileInput.removeEventListener("change",se),window.removeEventListener("focus",v)});function m(){let b=r.inputEl.value,E=I(b),R=Ni(b),$=C(b,E);return!R.trim()&&$.length===0?null:E.length>0&&M?.supports_vision===!1?(new ke.Notice("\u5F53\u524D\u540E\u7AEF\u6A21\u578B\u672A\u5F00\u542F\u89C6\u89C9\u80FD\u529B\uFF0C\u56FE\u7247\u5DF2\u4FDD\u7559\u5728\u8F93\u5165\u6846\u91CC\uFF0C\u6682\u65F6\u4E0D\u80FD\u53D1\u9001\u3002"),null):{request:{content:b,pasted_contents:E.map(({preview_url:j,size_bytes:J,...X})=>X)},displayText:R,displayAttachments:$}}function g(){x(),r.inputEl.value="",Ye(),ee()}function h(){x(),k.splice(0).forEach(b=>b())}function x(){l={},o=[],c=0,u=null,ot(),r.composerPillsEl.empty(),te()}async function w(){if(!(typeof navigator>"u"||!navigator.clipboard||typeof navigator.clipboard.read!="function")&&!(Date.now()-S<15e3))try{(await navigator.clipboard.read()).some(R=>R.types.some($=>$.startsWith("image/")))&&(S=Date.now(),new ke.Notice("\u526A\u8D34\u677F\u91CC\u6709\u56FE\u7247\uFF0C\u53EF\u4EE5\u76F4\u63A5\u7C98\u8D34\u5230\u5BF9\u8BDD\u6846\u3002"))}catch{}}async function y(b){if(Object.keys(l).length+b.length>Er){new ke.Notice(`\u6BCF\u6B21\u6700\u591A\u9644\u5E26 ${Er} \u5F20\u56FE\u7247\u3002`);return}for(let R of b){if(R.size>Oi){new ke.Notice(`${R.name} \u8D85\u8FC7 10 MB\uFF0C\u5DF2\u8DF3\u8FC7\u3002`);continue}let $=await Wi(R),[j,J]=$.split(",",2);if(!J)continue;let X=Yi(j)||R.type||"image/png",xe=await Gi($),vt=a++;l[vt]={id:vt,type:"image",data:J,media_type:X,filename:R.name||`Image ${vt}`,width:xe?.width,height:xe?.height,preview_url:$,size_bytes:R.size},H(vt)}ie(),ee()}function C(b,E){let R=D(b),$=E.map(j=>({type:"image",filename:j.filename,media_type:j.media_type,width:j.width,height:j.height,preview_url:j.preview_url}));return[...R,...$]}function D(b){let E=Fi(b),R=[];for(let $ of E){let j=$.path,J=e.vault.getAbstractFileByPath(j);if(J instanceof ke.TFolder){let X={type:"vault_directory",path:j,entry_count:J.children.length};R.push(X)}else if(J instanceof ke.TFile){let X={type:"vault_file",path:j,line_start:$.line_start,line_end:$.line_end};R.push(X)}}return R}function I(b){let E=Array.from(b.matchAll(vn)).map(j=>Number(j[1])).filter(j=>Number.isFinite(j)),R=[],$=new Set;for(let j of E)$.has(j)||!l[j]||($.add(j),R.push(l[j]));return R}function Q(){let b=new Set(Array.from(r.inputEl.value.matchAll(vn)).map(E=>Number(E[1])));for(let[E,R]of Object.entries(l))b.has(Number(E))||delete l[Number(E)];ie()}function ie(){r.composerPillsEl.empty();for(let b of Object.values(l)){let E=r.composerPillsEl.createDiv({cls:"chat-image-pill"});E.createEl("img",{cls:"chat-image-pill-thumb",attr:{src:b.preview_url,alt:b.filename}}),E.createDiv({cls:"chat-image-pill-label"}).setText(b.filename);let $=E.createEl("button",{cls:"chat-image-pill-remove",attr:{"aria-label":`Remove ${b.filename}`}});$.setText("\xD7"),$.addEventListener("click",()=>{delete l[b.id],r.inputEl.value=r.inputEl.value.replace(new RegExp(`\\s*\\[Image\\s+#${b.id}\\]\\s*`,"g")," ").replace(/[ \t]{2,}/g," ").trim(),Ye(),ie(),ee()})}r.composerPillsEl.classList.toggle("has-items",Object.keys(l).length>0)}function ee(){let b=W();if(b){B(ne(b.query,b.from,b.to),`slash:${b.from}:${b.to}:${b.query}`);return}let E=O();if(E){B(ue(E.query,E.from,E.to),`mention:${E.from}:${E.to}:${E.query}`);return}B([])}function te(){if(r.suggestionListEl.empty(),o.length===0){r.suggestionListEl.classList.remove("is-open");return}r.suggestionListEl.classList.add("is-open"),o.forEach((b,E)=>{let R=r.suggestionListEl.createDiv({cls:"chat-suggestion-item"});E===c&&(R.classList.add("is-selected"),window.setTimeout(()=>{R.scrollIntoView({block:"nearest"})},0)),R.createDiv({cls:"chat-suggestion-title"}).setText(b.label),R.createDiv({cls:"chat-suggestion-desc"}).setText(b.description),R.addEventListener("mousedown",J=>{J.preventDefault(),U(b)})})}function U(b){let E=r.inputEl.value,R=E.slice(0,b.replaceFrom),$=E.slice(b.replaceTo);r.inputEl.value=`${R}${b.insertText}${$}`;let j=b.replaceFrom+b.insertText.length;r.inputEl.setSelectionRange(j,j),r.inputEl.focus(),Ye(),o=[],u=null,te(),Q()}function V(b){if(o.length>0)return!1;let E=r.inputEl.selectionStart??r.inputEl.value.length,R=r.inputEl.selectionEnd??E;if(E!==R||b==="up"&&!ft(E)||b==="down"&&!Zt(R))return!1;let $=ht();return $.length===0?!1:p==null?b==="down"?!1:(f=r.inputEl.value,p=$.length-1,$e($[p]),!0):b==="up"?(p===0||(p-=1,$e($[p])),!0):p>=$.length-1?(p=null,$e(f),!0):(p+=1,$e($[p]),!0)}function B(b,E=null){let R=o[c],$=E!=null&&E===u;if(o=b,u=E,o.length===0){c=0,te();return}if($&&R){let j=o.findIndex(J=>zi(J,R));if(j>=0){c=j,te();return}}c=$?Math.min(c,o.length-1):0,te()}function ne(b,E,R){let $=b.trim().toLowerCase();return i.map(J=>({skill:J,score:Ui(J,$)})).filter(J=>J.score>0||$.length===0).sort((J,X)=>X.score-J.score||J.skill.name.localeCompare(X.skill.name)).slice(0,8).map(({skill:J})=>({kind:"slash",label:`/${J.name}`,description:J.description,replaceFrom:E,replaceTo:R,insertText:`/${J.name} `}))}function ue(b,E,R){let $=b.trim().toLowerCase();return e.vault.getAllLoadedFiles().filter(Hi).map(X=>({candidate:X,score:ji(X,$)})).filter(X=>X.score>0||$.length===0).sort((X,xe)=>xe.score-X.score||X.candidate.path.localeCompare(xe.candidate.path)).slice(0,8).map(({candidate:X})=>({kind:"mention",label:X instanceof ke.TFolder?`@${X.path}/`:`@${X.path}`,description:X instanceof ke.TFolder?`${X.children.length} items`:X.basename,replaceFrom:E,replaceTo:R,insertText:`${Vi(X.path)} `}))}function W(){let b=r.inputEl.selectionStart??r.inputEl.value.length,R=r.inputEl.value.slice(0,b).match(Ri);if(!R||R.index==null)return null;let $=R.index+R[1].length,j=b;for(;j<r.inputEl.value.length&&!/\s/.test(r.inputEl.value[j]);)j+=1;return{query:R[2]??"",from:$,to:j}}function O(){let b=r.inputEl.selectionStart??r.inputEl.value.length,E=r.inputEl.value.slice(0,b),R=E.match(Ai);if(R&&R.index!=null){let X=R.index+R[1].length,xe=b;for(;xe<r.inputEl.value.length&&r.inputEl.value[xe]!=='"';)xe+=1;return r.inputEl.value[xe]==='"'&&(xe+=1),{query:R[2]??"",from:X,to:xe}}let $=E.match(Ii);if(!$||$.index==null)return null;let j=$.index+$[1].length,J=b;for(;J<r.inputEl.value.length&&!/\s/.test(r.inputEl.value[J]);)J+=1;return{query:$[2]??"",from:j,to:J}}function H(b){let E=`[Image #${b}]`;ae(`${ti()?" ":""}${E} `),Ye()}function ae(b){let E=r.inputEl.selectionStart??r.inputEl.value.length,R=r.inputEl.selectionEnd??E,$=r.inputEl.value;r.inputEl.value=`${$.slice(0,E)}${b}${$.slice(R)}`;let j=E+b.length;r.inputEl.setSelectionRange(j,j),r.inputEl.focus()}function $e(b){P=!0,r.inputEl.value=b;let E=b.length;r.inputEl.setSelectionRange(E,E),r.inputEl.focus(),Ye(),Q(),ee()}function ot(){p=null,f=""}function ht(){return s.messages.filter(b=>b.role==="user"&&!!b.content.trim()).map(b=>b.content)}function ft(b){return!r.inputEl.value.slice(0,b).includes(`
...
`:""}${y.text}`:y.type==="tool_use"&&y.name&&(w(),a.renderHistoricalTool({id:y.id,tool_use_id:y.id,name:y.name,tool:y.name,output:"(no output)",...m.get(y.id)||{}}));w();return}typeof v.content=="string"&&v.content&&a.appendMessage("assistant",v.content,!1,[],v.message_id)}async function K(v){try{await n.deleteSession(v),new _e.Notice("\u4F1A\u8BDD\u5DF2\u5220\u9664"),await c(),n.sessionId===null&&(d(),s.treePanelTitleEl.setText("\u4F1A\u8BDD\u6811"),s.treeListEl.empty())}catch{new _e.Notice("\u5220\u9664\u5931\u8D25")}}async function A(v){if(n.sessionId===v)try{let g=(await n.listSessions()).find(h=>h.id===v);if(!g)return;s.sessionTitleEl.getText()==="\u65B0\u4F1A\u8BDD"&&g.title&&s.sessionTitleEl.setText(g.title),i.treePanelOpen&&(s.treePanelTitleEl.setText(g.title?`\u4F1A\u8BDD\u6811 \xB7 ${g.title}`:"\u4F1A\u8BDD\u6811"),u())}catch{}}async function G(v){if(o.hasRunningSession(n.sessionId)){new _e.Notice("\u5F53\u524D\u6B63\u5728\u56DE\u590D\uFF0C\u8BF7\u5148\u5B8C\u6210\u540E\u518D\u5206\u53C9");return}let m=n.sessionId,g=n.conversationId;if(!m||!g){new _e.Notice("\u5F53\u524D\u6CA1\u6709\u53EF\u5206\u53C9\u7684\u4F1A\u8BDD");return}let h=Pa(v.content),x=wa(v.content),w=await xa(e,x,h);if(w!==null)try{let y=await n.forkConversation(m,g,v.messageId,w);await L(y)}catch(y){let C=y instanceof Error?y.message:String(y);new _e.Notice(`\u5206\u53C9\u5931\u8D25: ${C}`)}}function q(v){let m=s.sessionListEl.createDiv({cls:"session-card"}),g=n.sessionId===v.id;g&&m.addClass("active");let h=m.createDiv({cls:"session-card-content"});h.createDiv({cls:"session-card-title"}).setText(v.title||"\u672A\u547D\u540D\u4F1A\u8BDD");let w=h.createDiv({cls:"session-card-meta"}),y=v.turn_count>0?`${v.turn_count} \u6B21\u5BF9\u8BDD`:`${v.message_count} \u6761\u6D88\u606F`;w.setText(`${y} \xB7 ${ba(v.created_at)}`),g&&h.createEl("span",{cls:"session-card-badge"}).setText("\u5F53\u524D");let C=o.getSessionStatus(v.id);if(C&&h.createEl("span",{cls:`session-card-badge session-card-runtime ${C}`}).setText(ka(C)),h.addEventListener("click",()=>{f(),L(v)}),!g){let D=m.createEl("button",{cls:"session-card-delete",attr:{"aria-label":"\u5220\u9664\u4F1A\u8BDD"}});D.innerHTML=Fr,D.addEventListener("click",I=>{if(I.stopPropagation(),o.hasRunningSession(v.id)){new _e.Notice("\u8BE5\u4F1A\u8BDD\u4ECD\u5728\u56DE\u590D\u4E2D\uFF0C\u8BF7\u5B8C\u6210\u6216\u505C\u6B62\u540E\u518D\u5220\u9664\u3002");return}K(v.id)})}}function re(v,m,g){for(let h of v){let x=m.createDiv({cls:"conversation-tree-branch"}),w=x.createEl("button",{cls:"conversation-tree-node",attr:{type:"button","aria-pressed":h.active?"true":"false",title:h.active?"\u5F53\u524D\u5206\u652F":"\u5207\u6362\u5230\u8BE5\u5206\u652F"}});h.active&&w.addClass("active");let y=w.createDiv({cls:"conversation-tree-node-main"});if(y.createDiv({cls:"conversation-tree-node-title"}).setText(h.title||"\u672A\u547D\u540D\u5206\u652F"),y.createSpan({cls:"conversation-tree-node-badge"}).setText(h.active?"\u5F53\u524D":`v${h.revision}`),w.createDiv({cls:"conversation-tree-node-meta"}).setText([`${h.message_count} \u6761`,h.fork_message_id?`fork ${h.fork_message_id.slice(0,8)}`:"",h.parent_id?`parent ${h.parent_id.slice(0,8)}`:"root"].filter(Boolean).join(" \xB7 ")),w.addEventListener("click",()=>{if(!h.active){if(o.hasRunningSession(g)){new _e.Notice("\u5F53\u524D\u6B63\u5728\u56DE\u590D\uFF0C\u8BF7\u5148\u5B8C\u6210\u540E\u518D\u5207\u6362\u5206\u652F");return}se(g,h.id)}}),h.children.length>0){let Q=x.createDiv({cls:"conversation-tree-children"});re(h.children,Q,g)}}}async function se(v,m){try{let g=await n.patchSession(v,{active_conversation_id:m});await L(g)}catch(g){let h=g instanceof Error?g.message:String(g);new _e.Notice(`\u5207\u6362\u5206\u652F\u5931\u8D25: ${h}`)}}return{handleNewSession:k,toggleSessionPanel:S,toggleTreePanel:M,loadSessionList:c,loadConversationTree:u,switchToSession:L,deleteSessionConfirm:K,syncCurrentSessionTitle:A}}var es="crabby-chat-styles",ts=`
  .crabby-chat {
    position: relative;
    display: flex;
...
`)}function La(t){let e=r=>r.replace(/\.0$/,""),n=Math.abs(t);if(n>=1e6){let r=n>=1e7?0:1;return`${e((t/1e6).toFixed(r))}m`}return n>=1e3?`${e((t/1e3).toFixed(1))}k`:`${Math.round(t)}`}function de(t){return Math.round(t).toLocaleString("en-US")}function Ra(t){let e=t>=10?0:1;return`${t.toFixed(e).replace(/\.0$/,"")}%`}function Ce(t,e){let n=t[e];return typeof n=="number"?n:0}function Aa(t){return t?Ce(t,"prompt_cache_hit_tokens")+Ce(t,"prompt_cached_tokens")+Ce(t,"cache_read_input_tokens"):0}function $t(t){return!!t&&(t.call_count>0||t.prompt_tokens>0||t.completion_tokens>0||t.total_tokens>0||t.reasoning_tokens>0||Aa(t)>0||Ce(t,"prompt_cache_miss_tokens")>0||Ce(t,"cache_creation_input_tokens")>0)}function Ia(t,e){let n=$t(e)?e:t;return $t(n)?La(n.total_tokens):"\u6682\u65E0"}function Ba(t){let e=[],n=Ce(t,"prompt_cache_hit_tokens"),r=Ce(t,"prompt_cache_miss_tokens"),s=Ce(t,"prompt_cached_tokens"),i=Ce(t,"cache_creation_input_tokens"),a=Ce(t,"cache_read_input_tokens");return n>0&&e.push(`\u547D\u4E2D ${de(n)}`),s>0&&e.push(`\u5DF2\u7F13\u5B58 ${de(s)}`),a>0&&e.push(`\u8BFB\u7F13\u5B58 ${de(a)}`),r>0&&e.push(`\u672A\u547D\u4E2D ${de(r)}`),i>0&&e.push(`\u5EFA\u7F13\u5B58 ${de(i)}`),e.length>0?e.join("\uFF0C"):null}function is(t,e){let n=Ce(e,"reasoning_tokens"),r=n>0?`\uFF08\u542B\u63A8\u7406 ${de(n)}\uFF09`:"",s=[`${t}\uFF1A${de(e.total_tokens)} tokens\uFF0C${de(e.call_count)} \u6B21\u6A21\u578B\u8C03\u7528\u3002`,`  \u8F93\u5165\uFF1A${de(e.prompt_tokens)}\u3002`,`  \u8F93\u51FA\uFF1A${de(e.completion_tokens)}${r}\u3002`],i=Ba(e);return i&&s.push(`  \u8F93\u5165\u7F13\u5B58\uFF1A${i}\u3002`),s}function $a(t,e){let n=["\u5F53\u524D\u4E0A\u4E0B\u6587\u7A97\u53E3",`\u5360\u7528\uFF1A${de(t.total_tokens)} / ${de(t.context_limit)} tokens\uFF08${e}\uFF09\u3002`,`\u7EC4\u6210\uFF1A\u7CFB\u7EDF ${de(t.system_tokens)}\uFF0C\u5DE5\u5177\u5B9A\u4E49 ${de(t.schema_tokens)}\uFF0C\u7528\u6237 ${de(t.user_tokens)}\uFF0C\u52A9\u624B ${de(t.assistant_tokens)}\uFF0C\u5DE5\u5177\u7ED3\u679C ${de(t.tool_result_tokens)}\u3002`,`\u6D88\u606F\u6570\uFF1A${de(t.message_count)}\u3002`,"","\u670D\u52A1\u5546\u7528\u91CF\uFF08usage\uFF09"],r=t.actual_usage,s=t.cumulative_usage;return $t(r)?n.push(...is("\u672C\u8F6E",r)):n.push("\u672C\u8F6E\uFF1A\u5F53\u524D\u6A21\u578B\u6CA1\u6709\u8FD4\u56DE usage \u6570\u636E\u3002"),$t(s)&&n.push(...is("\u4F1A\u8BDD\u7D2F\u8BA1",s)),n.push(""),n.push("\u8BF4\u660E\uFF1A\u4E0A\u4E0B\u6587\u662F\u5F53\u524D\u7A97\u53E3\u4F30\u7B97\uFF1Busage \u662F\u670D\u52A1\u5546\u8FD4\u56DE\u7684\u8C03\u7528\u7D2F\u8BA1\uFF0C\u5DE5\u5177\u5FAA\u73AF\u4F1A\u4EA7\u751F\u591A\u6B21\u6A21\u578B\u8C03\u7528\uFF0C\u7F13\u5B58\u548C\u63A8\u7406\u6309\u4F9B\u5E94\u5546\u53E3\u5F84\u5C55\u793A\u3002"),n.join(`
...
`};function us(t,e){if((0,Me.mkdirSync)(t,{recursive:!0}),(0,Me.readdirSync)(t).length>0)return!1;for(let[n,r]of Object.entries(e))gs(t,n,r);return!0}function ps(t){(0,Me.mkdirSync)(t,{recursive:!0});let e=Ha(t);return e.length===0?(cs(t,Dn),{seeded:!0,migrated:!1}):ja(e)?{seeded:cs(t,Dn),migrated:!1}:{seeded:!1,migrated:!1}}function cs(t,e){let n=!1;for(let[r,s]of Object.entries(e)){let i=(0,rt.join)(t,...r.split("/"));(0,Me.existsSync)(i)||(gs(t,r,s),n=!0)}return n}function Ha(t){return ms(t).filter(e=>e.split("/").pop()==="PERSONA.md").sort()}function ja(t){let e=Object.keys(Dn).filter(n=>n.endsWith("/PERSONA.md")).sort();return t.length>0&&t.every(n=>e.includes(n))}function ms(t,e=""){let n=e?(0,rt.join)(t,...e.split("/")):t,r=(0,Me.readdirSync)(n,{withFileTypes:!0}),s=[];for(let i of r){let a=e?`${e}/${i.name}`:i.name;i.isDirectory()?s.push(...ms(t,a)):i.isFile()&&s.push(a)}return s}function gs(t,e,n){let r=(0,rt.join)(t,...e.split("/"));(0,Me.mkdirSync)((0,rt.dirname)(r),{recursive:!0}),(0,Me.writeFileSync)(r,n.endsWith(`
`)?n:`${n}
`,"utf8")}var le=require("node:fs"),ut=require("node:path");function Va(t){let{legacyPath:e,targetPath:n}=t;if(!(0,le.existsSync)(e))return We(t,"missing",0,0,"legacy directory is absent");try{if(!(0,le.statSync)(e).isDirectory())return We(t,"blocked",0,1,"legacy path is not a directory");if(!(0,le.existsSync)(n))return(0,le.mkdirSync)((0,ut.dirname)(n),{recursive:!0}),vs(e,n),We(t,"moved",1,0,"moved legacy directory");if(!(0,le.statSync)(n).isDirectory())return We(t,"blocked",0,1,"target path is not a directory");let r=fs(e,n);return bs(e),r.movedEntries>0?We(t,"merged",r.movedEntries,r.skippedEntries,"merged missing legacy entries into existing directory"):We(t,r.skippedEntries>0?"skipped":"merged",r.movedEntries,r.skippedEntries,r.skippedEntries>0?"existing target entries were kept":"legacy directory was empty")}catch(r){let s=r instanceof Error?r.message:String(r);return We(t,"failed",0,1,s)}}function hs(t){return t.map(e=>Va(e))}function fs(t,e){let n={movedEntries:0,skippedEntries:0};(0,le.mkdirSync)(e,{recursive:!0});for(let r of(0,le.readdirSync)(t)){let s=(0,ut.join)(t,r),i=(0,ut.join)(e,r);if(!(0,le.existsSync)(i)){vs(s,i),n.movedEntries+=1;continue}let a=(0,le.statSync)(s),l=(0,le.statSync)(i);if(a.isDirectory()&&l.isDirectory()){let o=fs(s,i);n.movedEntries+=o.movedEntries,n.skippedEntries+=o.skippedEntries,bs(s);continue}n.skippedEntries+=1}return n}function vs(t,e){try{(0,le.renameSync)(t,e)}catch{(0,le.cpSync)(t,e,{recursive:!0,errorOnExist:!0,force:!1})}}function bs(t){try{(0,le.rmdirSync)(t)}catch{}}function We(t,e,n,r,s){return{...t,status:e,movedEntries:n,skippedEntries:r,message:s}}var ve=require("node:path");function ys(t){return t===".."||t.startsWith(`..${ve.sep}`)}function ks(t,e){let n=(0,ve.resolve)(t),r=(0,ve.resolve)(n,e),s=(0,ve.relative)(n,r);return!s||(0,ve.isAbsolute)(s)||ys(s)?r:s}function xs(t,e){let n=e?.trim();if(!n)return null;let r=(0,ve.resolve)(t),s=(0,ve.resolve)(r,n);if((0,ve.isAbsolute)(n))return s;let i=(0,ve.relative)(r,s);return!i||(0,ve.isAbsolute)(i)||ys(i)?null:s}var za="crabby",Ae="127.0.0.1",Ps=8e3,Ka=15e3,ws=2500,Ln=1200,qa=5e3,Wa=180,Ya=["user","feedback","project","reference"],Ga=`# Memory Operating Rules
