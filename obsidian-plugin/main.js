...
`)}}function ca(t){return Wr.some(e=>t.includes(e.open))}function da(t,e){let n=null;for(let r of Wr){let s=t.indexOf(r.open,e);s>=0&&(!n||s<n.openIndex)&&(n={tag:r,openIndex:s})}return n}function ua(t,e,n){let r=n+e.open.length;if(!e.allowNested)return t.indexOf(e.close,r);let s=pa(t,e,n);if(s>=0)return s;let i=1,a=r;for(;a<t.length;){let l=t.indexOf(e.open,a),o=t.indexOf(e.close,a);if(o<0)return-1;if(l>=0&&l<o){i+=1,a=l+e.open.length;continue}if(i-=1,i===0)return o;a=o+e.close.length}return-1}function pa(t,e,n){if(n!==0)return-1;let r=`
${e.close}
...
`)?n:`${n}
`,"utf8")}var oe=require("node:fs"),ut=require("node:path");function Va(t){let{legacyPath:e,targetPath:n}=t;if(!(0,oe.existsSync)(e))return Ye(t,"missing",0,0,"legacy directory is absent");try{if(!(0,oe.statSync)(e).isDirectory())return Ye(t,"blocked",0,1,"legacy path is not a directory");if(!(0,oe.existsSync)(n))return(0,oe.mkdirSync)((0,ut.dirname)(n),{recursive:!0}),vs(e,n),Ye(t,"moved",1,0,"moved legacy directory");if(!(0,oe.statSync)(n).isDirectory())return Ye(t,"blocked",0,1,"target path is not a directory");let r=fs(e,n);return bs(e),r.movedEntries>0?Ye(t,"merged",r.movedEntries,r.skippedEntries,"merged missing legacy entries into existing directory"):Ye(t,r.skippedEntries>0?"skipped":"merged",r.movedEntries,r.skippedEntries,r.skippedEntries>0?"existing target entries were kept":"legacy directory was empty")}catch(r){let s=r instanceof Error?r.message:String(r);return Ye(t,"failed",0,1,s)}}function hs(t){return t.map(e=>Va(e))}function fs(t,e){let n={movedEntries:0,skippedEntries:0};(0,oe.mkdirSync)(e,{recursive:!0});for(let r of(0,oe.readdirSync)(t)){let s=(0,ut.join)(t,r),i=(0,ut.join)(e,r);if(!(0,oe.existsSync)(i)){vs(s,i),n.movedEntries+=1;continue}let a=(0,oe.statSync)(s),l=(0,oe.statSync)(i);if(a.isDirectory()&&l.isDirectory()){let o=fs(s,i);n.movedEntries+=o.movedEntries,n.skippedEntries+=o.skippedEntries,bs(s);continue}n.skippedEntries+=1}return n}function vs(t,e){try{(0,oe.renameSync)(t,e)}catch{(0,oe.cpSync)(t,e,{recursive:!0,errorOnExist:!0,force:!1})}}function bs(t){try{(0,oe.rmdirSync)(t)}catch{}}function Ye(t,e,n,r,s){return{...t,status:e,movedEntries:n,skippedEntries:r,message:s}}var fe=require("node:path");function ys(t){return t===".."||t.startsWith(`..${fe.sep}`)}function ks(t,e){let n=(0,fe.resolve)(t),r=(0,fe.resolve)(n,e),s=(0,fe.relative)(n,r);return!s||(0,fe.isAbsolute)(s)||ys(s)?r:s}function xs(t,e){let n=e?.trim();if(!n)return null;let r=(0,fe.resolve)(t),s=(0,fe.resolve)(r,n);if((0,fe.isAbsolute)(n))return s;let i=(0,fe.relative)(r,s);return!i||(0,fe.isAbsolute)(i)||ys(i)?null:s}var za="crabby",Ae="127.0.0.1",Ps=8e3,Ka=15e3,ws=2500,Ln=1200,qa=5e3,Ya=180,Wa=["user","feedback","project","reference"],Ga=`# Memory Operating Rules
